...
## [14.0.0](https://github.com/brightly-salty/tokei/compare/v13.0.0...v14.0.0) - 2025-12-26

### Added

- add support for C++20 modules ([#1278](https://github.com/brightly-salty/tokei/pull/1278))
- Add language support for Ark TypeScript ([#1300](https://github.com/brightly-salty/tokei/pull/1300))

### Other

- Fix downcast type mismatches in clap_builder ([#1310](https://github.com/brightly-salty/tokei/pull/1310))
- remove tokei.rs references
- Add support for Koka ([#1306](https://github.com/brightly-salty/tokei/pull/1306))
- Stop recommending comma-separated CLI args ([#1305](https://github.com/brightly-salty/tokei/pull/1305))
- Update clap-cargo from 0.13 to 0.18 ([#1298](https://github.com/brightly-salty/tokei/pull/1298))
