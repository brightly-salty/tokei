...
## [13.0.0-alpha.8](https://github.com/brightly-salty/tokei/compare/v13.0.0-alpha.7...v13.0.0-alpha.8) - 2024-12-20

### Other

- Add support for 8th language ([#1192](https://github.com/brightly-salty/tokei/pull/1192))
- Add support for `Roc` language ([#1197](https://github.com/brightly-salty/tokei/pull/1197))
- Add support for Ballerina language ([#1196](https://github.com/brightly-salty/tokei/pull/1196))
- Remove 'conf' extension from the Bitbake config. ([#1001](https://github.com/brightly-salty/tokei/pull/1001))
- Add support for Cairo language ([#1193](https://github.com/brightly-salty/tokei/pull/1193))
- Add support for Uiua language ([#1191](https://github.com/brightly-salty/tokei/pull/1191))
