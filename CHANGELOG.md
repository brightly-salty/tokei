...
## [13.0.0-alpha.2](https://github.com/brightly-salty/tokei/compare/v13.0.0-alpha.1...v13.0.0-alpha.2) - 2024-07-19

### Added
- --files argument now sorts alphabetically ([#1059](https://github.com/brightly-salty/tokei/pull/1059))
- add support for LALRPOP ([#1077](https://github.com/brightly-salty/tokei/pull/1077))

### Fixed
- read hidden from config file ([#1093](https://github.com/brightly-salty/tokei/pull/1093))

### Other
- [issue_1114] remove Cargo.lock from .gitignore ([#1115](https://github.com/brightly-salty/tokei/pull/1115))
- [issue_891] give more space for Files column ([#933](https://github.com/brightly-salty/tokei/pull/933))
- GitHub Action to publish docker images ([#1096](https://github.com/brightly-salty/tokei/pull/1096))
- Support MoonBit language. ([#1095](https://github.com/brightly-salty/tokei/pull/1095))
- Add OpenSCAD ([#1097](https://github.com/brightly-salty/tokei/pull/1097))
- add jinja extension for Jinja2 ([#1083](https://github.com/brightly-salty/tokei/pull/1083))
- Fix slang ([#1089](https://github.com/brightly-salty/tokei/pull/1089))
- Temporarily remove Hare
- Support .pyi python file ([#1075](https://github.com/brightly-salty/tokei/pull/1075))
- add luau extension to lua ([#1066](https://github.com/brightly-salty/tokei/pull/1066))
- Adding support for Snakemake ([#1045](https://github.com/brightly-salty/tokei/pull/1045))
- Add Janet to languages.json ([#1042](https://github.com/brightly-salty/tokei/pull/1042))
- Add OpenQASM support ([#1041](https://github.com/brightly-salty/tokei/pull/1041))
- typst ([#1037](https://github.com/brightly-salty/tokei/pull/1037))
- Add the ZoKrates language ([#1035](https://github.com/brightly-salty/tokei/pull/1035))
- Add PRQL ([#1030](https://github.com/brightly-salty/tokei/pull/1030))
- remove refs ([#1006](https://github.com/brightly-salty/tokei/pull/1006))
- Add lingua franca language ([#993](https://github.com/brightly-salty/tokei/pull/993))
- Add support for Razor Components ([#992](https://github.com/brightly-salty/tokei/pull/992))
- Add arch's PKGBUILD files ([#972](https://github.com/brightly-salty/tokei/pull/972))
- Add Hare support ([#971](https://github.com/brightly-salty/tokei/pull/971))
- Add Max support ([#963](https://github.com/brightly-salty/tokei/pull/963))
- Add support for Chapel ([#960](https://github.com/brightly-salty/tokei/pull/960))
- Add language support for Slang ([#956](https://github.com/brightly-salty/tokei/pull/956))
- Update TypeScript language ([#953](https://github.com/brightly-salty/tokei/pull/953))
- Added support for Circom ([#949](https://github.com/brightly-salty/tokei/pull/949))
- link to earthly project ([#1078](https://github.com/brightly-salty/tokei/pull/1078))
